...
[Go Report Card](https://github.com/LWRGitHub/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: I will use the Google Translate library. The documentation is located [here](https://cloud.google.com/translate/docs/reference/libraries/v3/go) . My goal is to use it to create a flag to be able to translate the html files in any language.
- [x] **Add, commit, and push to GitHub**.
